...
async function getToken() {
    ...
    return new Promise((resolve, reject) => {
        ...
        var tokenUrl = 'https://proxyserver-z74x.onrender.com:3000/et/as/connect/token'; // Proxy server URL
...
document.getElementById('viewBasketAll').addEventListener('click', function() {
    ...
    var postUrl = 'https://proxyserver-z74x.onrender.com:3000/et/pos/external-basket/v1'; // Proxy server URL
